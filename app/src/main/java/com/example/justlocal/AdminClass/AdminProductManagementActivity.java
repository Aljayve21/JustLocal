...
import com.example.justlocal.databinding.ActivityAdminProductManagementBinding;
...
public class AdminProductManagementActivity extends AppCompatActivity {
    ...
    private ActivityAdminProductManagementBinding binding;
    ...
    private void loadProducts() {
        ...
        productsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(AdminProductManagementActivity.this, "Failed to load products: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void onProductClick(Product product) {
        ...
        Intent intent = new Intent(this, EditAdminProduct.class);
